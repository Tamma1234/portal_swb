                        ...
                        <div class="thumbnail_images">
                            <ul id="thumbnail">
                                <li><img onclick="changeImage(this)"
                                         src="https://drive.google.com/file/d/15oXFbTUAJKmy5qt9aJ-EwrdYGHmkOWpN/view"
                                         width="70"></li>
                            </ul>
                        </div>
                    </div>
...
{{--                                        ?>--}}
{{--                                        <input type="hidden" name="gold_sale" value="{{ round($gold_sale) }}">--}}
{{--                                        <span class="kt-pricing-1__price_primary" id="pricing-1__price"--}}
{{--                                              style="font-size: x-large;color: #999999;font-family: unset;text-decoration: line-through">{{ $item->gold }}--}}
{{--                                                                        </span>--}}
{{--                                        <span class="kt-pricing-1__price" id="pricing-1-sale"--}}
{{--                                              style="font-size: x-large;color: red;font-family: unset;">{{ round($gold_sale) }}--}}
{{--                                                                        </span>--}}
{{--                                        </span>--}}
{{--                                    @endif--}}
{{--                                @endforeach--}}
{{--                            @endif--}}
                        ...
                        <div class="buttons d-flex flex-row mt-5 gap-3">
                            <button type="button" class="btn btn-outline-dark" data-toggle="modal"
                                    data-target="#exampleModal">Buy Now
                            </button>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel"> Bạn có chắc chắn muốn mua sản
                                            phẩm này không</h5>
