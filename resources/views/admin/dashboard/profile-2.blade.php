...
{{--                            <div class="kt-wizard-v2__content" data-ktwizard-type="step-content">--}}
{{--                                <div class="kt-heading kt-heading--md">Postal address/ Địa chỉ nhận thư</div>--}}
{{--                                <div class="kt-form__section kt-form__section--first">--}}
{{--                                    <div class="kt-wizard-v2__form">--}}
{{--                                        <div class="row">--}}
{{--                                            <div class="col-xl-6">--}}
{{--                                                <div class="form-group">--}}
{{--                                                    <label>House number&street/ Số nhà & tên đường</label>--}}
...
{{--                                            <div class="col-xl-6">--}}
{{--                                                <div class="form-group">--}}
{{--                                                    <label>District or town/ Quận huyện</label>--}}
{{--                                                    <input type="text" class="form-control" name="district"--}}
{{--                                                           placeholder="District or town/ Quận huyện">--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                            <div class="col-xl-6">--}}
{{--                                                <div class="form-group">--}}
{{--                                                    <label>Province or City/ Tỉnh hoặc Thành phố</label>--}}
...
{{--                            <div class="kt-wizard-v2__content" data-ktwizard-type="step-content">--}}
{{--                                <div class="kt-heading kt-heading--md">ENGLISH PROFICIENCY TEST</div>--}}
{{--                                <div class="form-group">--}}
...
{{--                                                <div class="col-sm-1">--}}
{{--                                                    <a href="">Preview</a>--}}
{{--                                                    <input type="file" name="copy_certificate">--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <div class="kt-wizard-v2__review-item">--}}
...
{{--                                                <div class="col-sm-1">--}}
{{--                                                    <a href="">Preview</a>--}}
{{--                                                    <input type="file" name="copy_transcripts">--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <div class="kt-wizard-v2__review-item">--}}
...
{{--                                    Previous--}}
{{--                                </button>--}}
{{--                                <input type="submit" class="btn btn-success" data-ktwizard-type="action-submit" value="Submit">--}}
